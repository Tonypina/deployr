...
export function LatestChange() {
	...
	return (
		<div
			className={cn(
				"rounded-xl group/latest-change size-full min-h-27 justify-center border bg-background",
		...
		>
			...
			<Button className="w-max px-0 font-light text-xs" size="sm" variant="link" asChild>
